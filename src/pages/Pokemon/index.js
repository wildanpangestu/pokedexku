    ...
    <>
      ...
      {data?.pokemon && (
        <>
          ...
          >
            <FaArrowLeft size={25} color="#c52018" />{" "}
            <p> Kembali ke Beranda Pokedexku </p>
          </button>
                ...
                <div className="poke-details__card__infos__personal">
                  <div className="poke-details__card__infos__personal__data">
                    <div className="poke-details__card__infos__personal__data__height">
                      <h2>Tinggi</h2>
                      <p>Minimum: {data.pokemon.height.minimum}</p>
                      <p>Maksimum: {data.pokemon.height.maximum}</p>
                    </div>
                    <div className="poke-details__card__infos__personal__data__weight">
                      <h2>Berat</h2>
                      <p>Minimum: {data.pokemon.weight.minimum}</p>
                      <p>Maksimum: {data.pokemon.weight.maximum}</p>
                    </div>
                  </div>
                  ...
                  <div>Klasifikasi: {data.pokemon.classification}</div>
                </div>
              </div>
              <section
